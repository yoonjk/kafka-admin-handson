...
bin/kafka-producer-perf-test.sh --topic testuser01 --num-records 10000 --throughput 10 \
--payload-file $HOME/test/file10kb.txt --producer-props acks=1 bootstrap.servers=localhost:9092 --payload-delimiter A